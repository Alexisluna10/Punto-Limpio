...
urlpatterns = [
    ...
    path('panel-admin/corte-caja/',
         views.admin_corte_caja, name='admin_corte_caja'),
    path('panel-admin/historial/ventas/exportar-excel/',
         views.exportar_historial_ventas_excel, name='exportar_historial_ventas_excel'),
    path('panel-admin/historial/movimientos/exportar-excel/',
         views.exportar_historial_movimientos_excel, name='exportar_historial_movimientos_excel'),
    ...
    # URLs para gastos
    path('panel-admin/finanzas/guardar-renta/',
         views.guardar_gasto_renta, name='guardar_gasto_renta'),
    path('panel-admin/finanzas/guardar-servicio/',
         views.guardar_gasto_servicio, name='guardar_gasto_servicio'),
    path('panel-admin/finanzas/guardar-salario/',
         views.guardar_salario_empleado, name='guardar_salario_empleado'),

    # URL pública para el QR
    path('rastreo/qr/<int:pedido_id>/', views.rastreo_qr, name='rastreo_qr'),
    path('rastreo/buscar/', views.buscar_pedido_rastreo,
         name='buscar_pedido_rastreo'),
]
