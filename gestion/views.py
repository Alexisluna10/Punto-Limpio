...
def nuevo_servicio(request):
    ...
    if request.method == 'POST':
        try:
            ...
            # LÓGICA DE FECHA ENTREGA PARA AUTOSERVICIO
            tipo_servicio = data.get('tipo_servicio', 'por_encargo')

            if tipo_servicio == 'autoservicio':
                # Si es autoservicio, la fecha es AHORA MISMO
                fecha_entrega = timezone.now()
            else:
                # Si es encargo, tomamos la fecha del formulario
            ...
            pedido = Pedido.objects.create(
                ...
                origen='operador',
                fecha_entrega_estimada=fecha_entrega  # Usamos la variable procesada
            )
